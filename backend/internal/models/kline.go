...
type Kline struct {
	...
	Timestamp   time.Time `gorm:"not null;uniqueIndex:idx_klines_unique,priority:2;index:idx_klines_symbol_granularity_timestamp,priority:3,sort:desc;index:idx_klines_timestamp,sort:desc" json:"timestamp"`
